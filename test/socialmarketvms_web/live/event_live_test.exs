defmodule SocialmarketvmsWeb.EventLiveTest do
  use SocialmarketvmsWeb.ConnCase

  import Phoenix.LiveViewTest
  import Socialmarketvms.EventsFixtures

  @create_attrs %{name: "some name", date: "2025-02-18", description: "some description", location: "some location", start_time: "14:00"}
  @update_attrs %{name: "some updated name", date: "2025-02-19", description: "some updated description", location: "some updated location", start_time: "15:01"}
